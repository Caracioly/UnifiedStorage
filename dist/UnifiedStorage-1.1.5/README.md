...
- Supports optional integration with `ItemDrawers` (`kg_ItemDrawers`) and includes drawers in unified storage when available.
...
- Global scan cap is configurable via `MaxContainersScanned` (default: `128`) to balance coverage and performance.
...
- `v1.1.5`: [release-notes/v1.1.5.md](https://github.com/Caracioly/UnifiedStorage/blob/main/release-notes/v1.1.5.md)
- `v1.1.4`: [release-notes/v1.1.4.md](https://github.com/Caracioly/UnifiedStorage/blob/main/release-notes/v1.1.4.md)
...
- `kg_ItemDrawers` (drawer sources are included automatically when installed)
